...
import pandas as pd
import numpy as np
Final_all_dataset = pd.read_csv (r"input_dataset.csv")
...
history = model.fit(X_train_scaled, y_train, batch_size= 2500 ,validation_split=0.2, epochs =100, shuffle= True)
print("start")
